                ...
                <ul class="_sidebar_list">
                    <li>
                        <router-link to="/profile">
                            ...
                            <p class="_sidebar_list_text">{{$store.state.authUser.username}}</p>
                        </router-link>
                    </li>
                    <li>
                ...
                <ul class="_sidebar_list">
                    ...
                    <li>
                        <router-link to="">
                            ...
                            <button class="_sidebar_list_text" v-on:click="logOut">Log Out</button>
                        </router-link>
                    </li>
                </ul>
            </div>
  ...
  methods:{
      async logOut(){
          try {
              ...
              this.s('User Log out successfully !!');
